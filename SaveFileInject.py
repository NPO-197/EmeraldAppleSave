...
# The rest get written to the (unused) 14 sectors of "backup" save data.
with open("Data/LZSS_10FPSvidData.bin","br") as f:
...
# Update checksums for save sectors that are signed, and combine sectors into a new sav file
newSave = []
for sect in sectors:
...
with open("Out/EmeraldApple.sav","bw") as f:
